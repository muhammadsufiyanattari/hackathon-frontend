...
function SiginUp() {
  ...
  return (
    <section className={`${darkMode ? "bg-neutral-800" : ""} bg-gray-50  transition-colors duration-500`}>
      <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <div
          className={`${
            darkMode ? "bg-neutral-800" : ""
          } w-full bg-white rounded-lg transition-colors duration-500 shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700`}
        >
